...
public class ExampleUnitTest {
    ...
    public void test() throws Exception{
        ...
        JsonNode jsonNode=CommenUtil.toJsonNode(s);

        for(Object object:objects){
            JsonNode jsonNode1=CommenUtil.toJsonNode(CommenUtil.toJsonStr(object));
            System.out.println(CommenUtil.toBean(CommenUtil.toJsonStr(object),Room.class).getCommentNumber());
        }
    }
}