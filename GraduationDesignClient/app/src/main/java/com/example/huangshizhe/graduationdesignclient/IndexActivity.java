...
import com.example.huangshizhe.graduationdesignclient.fragments.CollecitonFragment;
import com.example.huangshizhe.graduationdesignclient.fragments.IndexFragment;
import com.example.huangshizhe.graduationdesignclient.fragments.UserFragment;
...
public class IndexActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomTabBar
                ...
                .addTabItem("收藏", R.mipmap.ic_launcher,CollecitonFragment.class)//设置文字、两张图片、fragment
                .addTabItem("我的",R.mipmap.ic_launcher,UserFragment.class)
                .isShowDivider(false)//设置是否显示分割线
                .setTabBarBackgroundColor(Color.WHITE)//设置底部导航栏颜色
                .setTabBarBackgroundResource(R.mipmap.ic_launcher_round)//设置底部导航栏的背景图片【与设置底部导航栏颜色方法不能同时使用，否则会覆盖掉前边设置的颜色】
